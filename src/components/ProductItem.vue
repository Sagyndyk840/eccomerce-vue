...
<template>
  <div class="product-item">
    ...
    <div class="product-wrapper">
      ...
      <div class="product-ex" v-if="newProduct">new</div>
    </div>
...
<!--      <div class="product-color color" style="background-color: #F1DDAA;"></div>-->
<!--      <div class="product-color color" style="background-color: #FFFFFF;"></div>-->
    </div>
  </div>
</template>
